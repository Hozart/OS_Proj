...
PUBLIC void* my_malloc(long MemoryLength);
PUBLIC struct DirTreeNode* NewDirTreeNode(char x[MAX_PATH]);
PUBLIC struct OriginLinkNode* NewOriginLinkNode(char x[MAX_PATH], char y[MAX_PATH]);
PUBLIC void AddOriginLinkNode(char x[MAX_PATH], char y[MAX_PATH]);
PUBLIC struct NodeStack* NewNodeStack(struct DirTreeNode* x);
PUBLIC void NodeStackPush(struct DirTreeNode* x);
PUBLIC struct DirTreeNode* NodeStackPop();
